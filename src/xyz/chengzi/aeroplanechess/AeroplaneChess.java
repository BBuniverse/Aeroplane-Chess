...
import xyz.chengzi.aeroplanechess.util.musicStuff;
...
//        String musicPath = "..\\Aeroplane-Chess\\src\\music.wav";
//        musicStuff musicObject = new musicStuff();
//        musicObject.playMusic(musicPath);
        ...
        read_Input.addActionListener(e -> {
            ...
            if (number_Of_Player[0] > 4 || number_Of_Player[0] < 2) {
                ...
                if (choose_AI_Interface() == 1) {
                    ...
                    response[0] = JOptionPane.showOptionDialog(null, "Number of AI chose", "Number_AI",
